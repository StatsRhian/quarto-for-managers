...
subtitle: The magic of automatic reporting ✨ 
author: Rhian Davies
format: 
  revealjs: 
    self-contained: true
...
- Open [binder](https://mybinder.org/v2/gh/StatsRhian/demo-quarto-for-managers/main?urlpath=rstudio) [![Launch RStudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/StatsRhian/demo-quarto-for-managers/main?urlpath=rstudio)
- _File_ ➡️ _New File_ ➡️ _Quarto Document_
